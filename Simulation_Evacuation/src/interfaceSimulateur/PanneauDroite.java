...
public class PanneauDroite extends JPanel {
    ...
    private JPanel createPannelPersonnes(CardLayout cardLayout) {
        ...
        JLabel etiquetteRayon = new JLabel("Rayon : 5 - 50");
        grilleRayon.add(etiquetteRayon);

        //ajout d'un range slider pour le rayon allant de 5 à 50
        RangeSlider sliderRayon = new RangeSlider();
        sliderRayon.setMinimum(5);
        sliderRayon.setMaximum(50);
        sliderRayon.setValue(5);
        sliderRayon.setUpperValue(50);
        ...
        JLabel etiquetteVitesse = new JLabel("Vitesse : 2 - 8");
        grilleVitesse.add(etiquetteVitesse);
        
        //ajout d'un range slider pour la vitesse allant de 2 à 8
        RangeSlider sliderVitesse = new RangeSlider();
        sliderVitesse.setMinimum(2);
        sliderVitesse.setMaximum(8);
        sliderVitesse.setValue(2);
        sliderVitesse.setUpperValue(8);
