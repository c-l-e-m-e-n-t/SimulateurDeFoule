...
public class Vecteur {
	...
	*/
	 ...
	 */
	public static Vecteur vecteurNormal(Pt p1, Pt p2) {
		double d = Pt.distancePoint(p1, p2);
	 ...
	 */
	public static Vecteur vecteurTangent(Pt p1, Pt p2) {
